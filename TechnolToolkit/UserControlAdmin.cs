...
namespace TechnolToolkit
{
    ...
    public partial class UserControlAdmin : UserControl
    {
        ...
        private void buttonDZC_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawImage(Form1.ResizeImage(Properties.Resources.icons8_UserSearcg_96_color, picSize, picSize), (buttonDZC.Width / 2) - (picSize / 2), 5);
        }
        ...
        {
            Graphics g = e.Graphics;
            g.DrawImage(Form1.ResizeImage(Properties.Resources.icons8_Software_96_color, picSize,picSize), (buttonInstalovanyProgramy.Width / 2) - (picSize / 2), 10);
        }

        private void buttonNajdiPC_Paint(object sender, PaintEventArgs e)
        {
            Graphics g = e.Graphics;
            g.DrawImage(Form1.ResizeImage(Properties.Resources.icons8_Laptop_96_color, picSize, picSize), (buttonNajdiPC.Width / 2) - (picSize / 2), 5);
        }
        ...
        {
            Graphics g = e.Graphics;
            g.DrawImage(Form1.ResizeImage(Properties.Resources.icons8_LaptopSearch_96_color, picSize, picSize), (buttonInfoPC.Width / 2) - (picSize / 2), 5);
        }
        ...
        {
            Graphics g = e.Graphics;
            g.DrawImage(Form1.ResizeImage(Properties.Resources.icons8_F1_Car_96_color, picSize, picSize), (buttonVAS.Width / 2) - (picSize / 2), 5);
        }
